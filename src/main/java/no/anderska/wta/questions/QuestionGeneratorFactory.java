...
public class QuestionGeneratorFactory {
    ...
    public static QuestionGeneratorFactory withAllQuestions() {
        ...
        questionFactory.put("MayanSort", SortMayanQuestionGenerator.class, 50);
        ...
        questionFactory.put("ToMayan", ToMayanQuestionGenerator.class, 40);
        questionFactory.put("ToSmallRoman", ToRomanQuestionGenerator.Small.class, 15);
        questionFactory.put("ToSmallMayan", ToMayanQuestionGenerator.Small.class, 15);
        questionFactory.put("FromRoman", FromRomanNumberQuestionGenerator.class, 40);
        questionFactory.put("FromMayan", FromMayanNumberQuestionGenerator.class, 40);
        questionFactory.put("FromSmallRoman", FromRomanNumberQuestionGenerator.Small.class, 15);
        questionFactory.put("FromSmallMayan", FromMayanNumberQuestionGenerator.Small.class, 15);
